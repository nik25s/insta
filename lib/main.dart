  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
        options: const FirebaseOptions(
            apiKey: 'AIzaSyDyk5tKrpBaZIgNeMiP5jUDrktLhQg5CFM',
            appId: '1:127334519336:web:db7333ef15f7e3fc88db1d',
            messagingSenderId: '127334519336',
            projectId: 'insta-clone-4ee39',
            storageBucket: 'insta-clone-4ee39.appspot.com'));
  } else {
    await Firebase.initializeApp();
  }
  runApp(const MyApp());
